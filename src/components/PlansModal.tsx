  ...
  return [
    {
      ...
      label:     "Trial",
      icon:      Zap,
      searches:  isB2B ? 50  : 20,
      trialDays: isB2B ? 14  : 7,
      price:     "Free",
      features: [
        { text: `${isB2B ? 50 : 20} searches/day`,   included: true  },
        ...
        { text: isB2B ? "API Access" : "Price Alerts", included: false },
    ...
    },
    {
      ...
      label:    "Free",
      icon:     CheckCircle,
      searches: isB2B ? 20  : 10,
      price:    "$0 / month",
      features: [
        { text: `${isB2B ? 20 : 10} searches/day`,    included: true  },
    ...
    },
    {
      ...
      label:    "Paid",
      icon:     Crown,
      searches: isB2B ? 200 : 50,
      price:    isB2B ? "Contact us" : "$20 / month",
      features: [
        { text: `${isB2B ? 200 : 50} searches/day`,   included: true  },
        { text: "Unlimited time",                      included: true  },
        { text: "AI Discovery",                        included: true  },
        { text: "AI Product Matching",                 included: true  },
        { text: "Price Tracking",                      included: true  },
        { text: "Export Data",                         included: true  },
        { text: isB2B ? "API Access" : "Price Alerts", included: true  },
