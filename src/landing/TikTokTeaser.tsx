      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {FEATURES.map(({ icon: Icon, title, desc }, idx) => (
            <Reveal key={title} delay={idx * 100} scale>
            <div className="p-5 rounded-2xl border bg-background/60 backdrop-blur-sm hover:bg-background/80 transition-colors group h-full">
